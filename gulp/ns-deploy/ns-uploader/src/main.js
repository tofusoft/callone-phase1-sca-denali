...
_(Tool.prototype).extend({
	...
	main: function (config)
	{
		...
		self.getFileNamed(config.targetFolderId, self.MANIFEST_FILE_NAME, true)
		...
		.then(function(uploadResults)
		{
			...
			return self.addOrUplodateFile(config.targetFolderId, self.MANIFEST_FILE_NAME, 
...
/*
@class MainConfig
@param sourceFolderPath @mandatory
*/