...
<div class="return-authorization-confirmation">
	...
	<div class="return-authorization-confirmation-module">
		...
		<a href="/returns/{{internalId}}" class="return-authorization-confirmation-module-body-return-id">{{translate 'Return request #$(0)' modelTranId}}</a></p>
		<p class="return-authorization-confirmation-module-body">
	...
	<h3>
		<span>{{translate 'From:'}}</span>{{translate '$(0) #$(1)' createdFromLabel modelTranId}}
