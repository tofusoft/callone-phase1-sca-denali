	...
	,	getContext: function ()
		{
			...
			return {
				...
				//@property {String} createdFromInternalId
			,	createdFromInternalId: this.createdFromModel.get('internalid')
				//@property {Boolean} iscreatedFromSalesOrder
			,	iscreatedFromSalesOrder: this.createdFromModel.get('type') === 'salesorder'
				//@property {String} createdFromURL
			,	createdFromURL: this.getLinkedRecordUrl()
				//@property {String} createdFromOrderNumber
			,	createdFromOrderNumber: this.createdFromModel.get('order_number')
