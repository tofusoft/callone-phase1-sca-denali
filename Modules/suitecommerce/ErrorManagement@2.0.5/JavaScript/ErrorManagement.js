	...
	,	mountToApp: function (application)
		{
			...
			,	unauthorizedError: function()
				{
					if (Configuration.currentTouchpoint === 'checkout')
					{
						ProfileModel.getInstance().set({ isLoggedIn: 'F', isGuest: 'F' });
					...
					else
					{
						...
						if (Configuration.currentTouchpoint)
						{
							url += '&origin=' + Configuration.currentTouchpoint;
						}
					...
					else if (Layout.currentView)
					{
						...
						if (intStatus !== 403)
						{
							...
							else
							{
								...
								{
									return childView.$('.focused-form-view').size() || childView.$el.is('.focused-form-view');
								});	
