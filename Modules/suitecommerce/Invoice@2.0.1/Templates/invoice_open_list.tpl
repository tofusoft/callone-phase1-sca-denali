...
<section class="invoice-open-list">
	...
	<div class="invoice-open-list-body">
		...
		{{else}}
			<p class="invoice-open-list-no-records">
				{{translate 'You don\'t have any Open Invoices at the moment,</br>see <a href="/paid-invoices" class="invoice-open-list-anchor-paid">Invoices Paid In Full</a>'}}
			</p>
		{{/if}}
	</div>
</section>