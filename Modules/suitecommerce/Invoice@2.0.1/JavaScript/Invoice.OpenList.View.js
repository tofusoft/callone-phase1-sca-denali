			...
			,	'Invoice.Results': function ()
				{
					var records_collection = new Backbone.Collection(this.collection.map(function (invoice)
					{
						...
						,	title: new Handlebars.SafeString(_('Invoice #<span class="tranid">$(0)</span>').translate(invoice.get('order_number')))
						...
						,	columns: [
							...
							,	{
								...
								,	composite: new InvoiceDateView({
										...
										,	isPartiallyPaid: invoice.get('summary').total - invoice.get('amountremaining')
										})
									})
								}
							,	{
								...
								,	type: 'currency'
								,	name: 'amount'
								,	value: invoice.get('total_formatted')
								}
							]
