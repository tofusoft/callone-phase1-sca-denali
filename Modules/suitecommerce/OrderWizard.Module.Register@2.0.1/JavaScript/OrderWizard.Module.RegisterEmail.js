	...
	)
{
	...
	,	isActive: function ()
		{
			return (this.profileModel.get('isGuest') === 'T' || (this.profileModel.get('isGuest') === 'F' && this.profileModel.get('isLoggedIn') === 'F' && this.profileModel.get('isRecognized') === 'F')) && this.wizard.application.getConfig('checkout_skip_login');
		}
