	...
	)
{
	...
	,	getContext: function ()
		{
			var is_confirmation_created = !!(this.model.get('confirmation') && this.model.get('confirmation').internalid !== '0')
			...
			return {
					...
					selectedInvoicesLength: is_confirmation_created ? model.invoices.length : 0
