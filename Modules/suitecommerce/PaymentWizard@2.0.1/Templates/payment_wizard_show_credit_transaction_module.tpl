...
<div class="payment-wizard-show-credit-transaction-module-accordion-divider">
	...
	<div class="payment-wizard-show-credit-transaction-module-accordion-body collapse" id="payment-wizard-show-credit-transaction-module-products" role="tabpanel" data-target="#payment-wizard-show-credit-transaction-module-products">
				...
				{{#each transactions}}
					<div class="payment-wizard-show-credit-transaction-module-accordion-container-row" data-id="{{id}}">
						...
						<div class="payment-wizard-show-credit-transaction-module-accordion-container-row-right">
							<p><span class="payment-wizard-show-credit-transaction-module-accordion-container-label">{{translate 'Amount:'}} </span> {{amountFormatted}}</p>
						</div>
					</div>
				{{/each}}
