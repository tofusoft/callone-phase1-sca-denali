	...
	,	initialize: function (options)
		{
			...
			this.creditCardIcons = Configuration.creditCardIcons;
		}
	...
	,	getContext: function()
		{
			...
			return {
					...
					model: this.model
					// @property {Object} creditCardIcons
				,	creditCardIcons: this.creditCardIcons
				...
				,	type: this.model.get('type') ? this.model.get('type') : _('Not specified').translate()
				...
				,	showCreditCardImage: this.creditCardIcons && credit_card_payment_method_name in this.creditCardIcons
					// @property {String} creditCardImageUrl
				,	creditCardImageUrl: this.creditCardIcons && this.creditCardIcons[credit_card_payment_method_name] || ''
