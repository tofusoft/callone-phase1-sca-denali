	...
	<form action="#" class="case-new-form" novalidate>
		<div class="case-new-form-controls-group" data-validation="control-group">
			...
			<div class="case-new-form-controls" data-validation="control">
				<input  data-action="text" type="text" name="title" id="title" class="case-new-form-input" value="" maxlength="300"></input>
			</div>
		</div>
		...
		<div class="collapse" data-collapse-content data-validation="control-group">
			...
			<div class="case-new-form-controls" data-validation="control">
				<input type="email" autofocus name="email" id="email" placeholder="{{translate 'yourname@company.com'}}" data-case-email class="case-new-form-input" value="" disabled="true" maxlength="300"></input>
			</div>
		</div>
