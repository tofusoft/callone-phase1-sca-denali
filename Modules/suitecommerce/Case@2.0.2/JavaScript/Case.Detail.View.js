	...
	,	closeCase: function (event)
		{
			...
			this.model.set('status', { id: SC.ENVIRONMENT.CASES_CONFIG.default_values.status_close.id });
	...
	,	getContext: function()
		{
			...
			,	closeStatusId: this.model.get('status').id !== SC.ENVIRONMENT.CASES_CONFIG.default_values.status_close.id
			};
		}
	});
});