...
<section>
	...
	<div class="deposit-application-details-accordion-divider">
		<div class="deposit-application-details-accordion-head">
			<a class="deposit-application-details-accordion-head-toggle" data-toggle="collapse" data-target="#deposit-application-applied-to-invoices" aria-expanded="true" aria-controls="deposit-application-applied-to-invoices">
