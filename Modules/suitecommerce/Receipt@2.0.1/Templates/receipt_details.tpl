...
<a href="/receiptshistory" class="receipt-details-back-btn">{{translate '&lt; Back to Receipts'}}</a>
<section>
	<header>
	...
	<div class="receipt-details-row">
		<div class="receipt-details-content-col">
			...
			<div class="receipt-details-accordion-divider">
				...
				<div class="receipt-details-accordion-body collapse" id="receipt-products-list" role="tabpanel" data-target="#receipt-products-list">
			...
			<div class="receipt-details-accordion-divider">
				...
				<div class="receipt-details-accordion-body collapse" id="receipt-payment-info" role="tabpanel" data-target="#receipt-payment-info">
					<div class="receipt-details-accordion-container" data-content="order-items-body">
