	...
	)
{
	...
	,	render: function ()
		{
			...
			//TODO USE Configuration.get('siteSettings.checkout.requireccsecuritycode', 'T')
	...
	,	changeCreditCard: function (e)
		{
			if (ProfileModel.getInstance().get('isGuest') !== 'T')
			{
	...
	,	getExpiredCreditCardError: function()
		{
			...
			,	errorMessage: _.translate('Your credit card has expired, please select another one.')
			};
		}
	...
	,	manageError: function (error)
		...
		// @method showSecureInfo Shows askdmfsk
