	...
	<div class="cart-summary-container">
		...
		<div class="cart-summary-subtotal">
			<p class="cart-summary-grid-float">
				<span class="cart-summary-amount-subtotal">
					...
					{{else}}
						{{translate 'Subtotal <span class="cart-summary-item-quantity-subtotal">$(0) items</span>'
						itemCount}}
					{{/if}}
			</p>
			{{#if showEstimate}}
		...
		{{#if showDiscount}}
			...
			{{#if promocodeValid}}
				<div class="cart-summary-promocode">
					<p class="cart-summary-grid-float">
						<span class="cart-summary-grid-right">
					...
					<div class="cart-summary-grid">
						<div class="cart-summary-promocode-text-success">
							<span class="cart-summary-promocode-code">#{{promocode.code}} - {{translate 'Instant Rebate'}}</span>
		...
		{{else}}
			<div class="cart-summary-shipping-cost-applied">
				...
				{{#if showHandlingCost}}
				<p class="cart-summary-grid-float">
					<div class="cart-summary-label-handling">
						{{translate 'Handling'}}
					</div>

					<div class="cart-summary-amount-handling">
		...
		<div class="cart-summary-grid">
			<div class="cart-summary-expander-head">
				<a class="cart-summary-expander-head-toggle collapsed" data-toggle="collapse" data-target="#promo-code-container" aria-expanded="false" aria-controls="promo-code-container">
					{{translate 'Have a Promo Code?'}} <i data-toggle="tooltip" class="cart-summary-expander-tooltip" title="{{translate '<b>Promo Code</b><br>To redeem a promo code, simply enter your information and we will apply the offer to your purchase during checkout.'}}"></i><i class="cart-summary-expander-toggle-icon"></i>
				</a>
			</div>
			<div class="cart-summary-expander-body collapse" id="promo-code-container" aria-expanded="false">
