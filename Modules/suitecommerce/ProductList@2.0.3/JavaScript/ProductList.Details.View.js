	...
	,	initialize: function (options)
		{
			...
			this.displayOptions = this.application.getConfig('product_lists_templates');
	...
	,	getContext: function()
		{
			...
			return {
				...
				showListHeader: !(items.length === 0 && this.model.get('type').name === 'predefined')
				// @property {Boolean} isTypePredefined
			,	isTypePredefined: this.model.get('type').name === 'predefined'
