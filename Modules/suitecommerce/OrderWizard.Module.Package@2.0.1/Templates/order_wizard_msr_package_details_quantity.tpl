...
<div class="order-wizard-msr-package-details-quantity">
	<div class="order-wizard-msr-package-details-quantity-count">
	...
	<div class="order-wizard-msr-package-details-quantity-amount">
		...
		<span class="order-wizard-msr-package-details-quantity-amount-value" data-type="item-amount"> {{ lineTotalFormatted }} </span>
