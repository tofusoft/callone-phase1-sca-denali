	...
	,	runStep: function ()
		{
			...
			if (this.steps[url])
			{
				...
				if ((this.application.Configuration.checkout_skip_login && this.application.getConfig('siteSettings.registration.registrationoptional') === 'T' && profile_model.get('isRecognized') === 'F') || profile_model.get('isLoggedIn') === 'T')
				{
