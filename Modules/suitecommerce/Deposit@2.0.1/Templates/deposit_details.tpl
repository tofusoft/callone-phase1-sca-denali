...
<section class="deposit-details">
	...
	<div class="deposit-details-accordion-divider">
		<div class="deposit-details-accordion-head">
			<a class="deposit-details-accordion-head-toggle" data-toggle="collapse" data-target="#deposit-applied-to-invoices" aria-expanded="true" aria-controls="deposit-applied-to-invoices">
	...
	<div class="deposit-details-accordion-divider">
		<div class="deposit-details-accordion-head">
			<a class="deposit-details-accordion-head-toggle-secondary collapsed" data-toggle="collapse" data-target="#deposit-billing" aria-expanded="true" aria-controls="deposit-billing">
				{{translate 'Billing & Payment Method'}}
				<i class="deposit-details-accordion-toggle-icon-secondary"></i>
			</a>
		</div>
		<div class="deposit-details-accordion-body collapse" id="deposit-billing" role="tabpanel" data-target="#deposit-billing">
