	...
	)
{
	...
	,	Model = BackboneCachedModel.extend({
		...
		,	validation:
			...
			// The api returns the items as an array always this takes care of returning the object
		...
		,	initialize: function ()
			{
				...
				Model.prototype.searchApiMasterOptions =  _.getPathFromObject(Configuration, 'searchApiMasterOptions.itemDetails', {});

				Model.prototype.itemOptionsConfig = _.getPathFromObject(Configuration, 'itemOptions', []);

				Model.prototype.itemOptionsDefaultTemplates = _.getPathFromObject(Configuration, 'templates.itemOptions', {});
			...
			//@method getOption @param {String} option_name @returns {String}
		,	getOption: function (option_name)
			{
				return this.itemOptions[option_name];
			}

			//@method setOptionsArray @param {Array<ItemDetails.Model.Option>} @param {Boolean} dont_validate
		...
		,	setOption: function (option_name, value, dont_validate)
			...
			// @method getItemOptionsForCart @returns {Object<String,ItemDetails.Model.Option>}
