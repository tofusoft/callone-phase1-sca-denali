	...
	)
{
	...
	// @method paymenthodIdCreditCart @param {String} cc_number @return {String} payment method internal id matching the passed credit card number if any or undefined.
	...
	function formatCurrency (value, symbol)
	{
		...
		if (!symbol)
		{
			...
			else if (SC.getSessionInfo && SC.getSessionInfo('currentCurrency'))
			{
	...
	// @method addParamsToUrl @param {String} baseUrl @param {Object} params the params mapping to add @return {String}
	...
	// @method hyphenate simple hyphenation of a string, replaces non-alphanumerical characters with hyphens @param {String} string @returns {String}
	...
	// @method reorderUrlParams @param {String} url @return {String} the url with reordered parameters
