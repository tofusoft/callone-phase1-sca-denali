...
<section class="customer-payment-details">
	...
	<div class="customer-payment-details-accordion-body collapse in" id="invoice-items" role="tabpanel" data-target="#invoice-items">
			...
			<table class="customer-payment-details-accordion-body-container-recordviews-table">
				<thead class="customer-payment-details-accordion-body-container-recordviews-table-header">
					<tr>
						...
						<th class="customer-payment-details-accordion-body-container-recordviews-currency" data-name="discount">
							{{translate 'Disc'}}
						</th>
	...
	<div class="customer-payment-details-accordion-head">
		<a class="customer-payment-details-accordion-head-toggle collapsed" data-toggle="collapse" data-target="#billing-payment-items" aria-expanded="true" aria-controls="billing-payment-items">
			{{translate 'Billing & Payment Method'}}
			<i class="customer-payment-details-accordion-toggle-icon"></i>
		</a>
	</div>
	<div class="customer-payment-details-accordion-body collapse" id="billing-payment-items" role="tabpanel" data-target="#billing-payment-items">
		<div class="customer-payment-details-accordion-container" data-content="order-items-body">
