define('Facets.CategoryFacet.Helper', [
    ...
    return {
        ...
        getCategoryListFromPath: function getCategoryListFromPath(categoryPath) {
            ...
            var categoriesList;
            var categoryLevel = categoryPath.length ;
            var currentCategory = categoryPath[categoryLevel - 1];
            var currentCategoryHasChildren = currentCategory && _.size(currentCategory.categories ) > 0;
