define('Facets.BrowseCategories.View', [
    ...
    facetsCategoryBrowseTpl,
    facetsCategoryCellListRow,
    Backbone,
    ...
    return Backbone.View.extend({
        ...
        template: facetsCategoryBrowseTpl,
        ...
        childViews: {
            'Facets.CategoryCellList': function FacetsCategoryCellList() {
                return new BackboneCollectionView({
                    ...
                    viewsPerRow: 4,
                    rowTemplate: facetsCategoryCellListRow
                });
            },
            'Facets.FacetedNavigation.Item.Category': function FacetsFacetedNavigationItemCategory(options) {
