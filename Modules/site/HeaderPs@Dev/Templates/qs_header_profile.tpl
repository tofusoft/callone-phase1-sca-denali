...
<div class="header-extra-menu-links" data-cms-area="extra-menu-links" data-cms-area-filters="global">
            ...
            <div class="header-profile-menu-login-container">
                <ul class="header-profile-menu-login">
                    ...
                    {{#if showRegister}}
                        ...
                        <li>
                            <a class="header-profile-register-link" data-touchpoint="register"
                               data-hashtag="login-register" href="#">
                                {{translate 'Register'}}
                            </a>
                        </li>
                    {{/if}}
